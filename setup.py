...
setup(
    ...
    ext_modules=[Extension(
        ...
        sources=['blockmask.c', 'thunk.c', 'thunkpackage.c', 'thunk_as_number.c', 'thunkops.c', 'thunk_binarypipeline.c', 'thunk_aggregationpipeline.c', 'thunk_unarypipeline.c', 'thunk_binaryfunction.c', 'thunk_unaryfunction.c', 'thunk_methods.c', 'ufunc_pipeline.c'] + generated_sources
        )])
